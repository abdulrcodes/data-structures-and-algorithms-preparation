...
//  m elements denote the elements that should be merged, and the last n elements are set to 0 and should be
...
//  is only there to ensure the merge result can fit in nums1.
  ...
  // let i = m -1 // last elements num1 valid part not include 0
  // let j = n -1 // last element of nums2
  // k = m+ n -1 //  last position in nums1 (including zeroes)
...
var merge = function (nums1, m, nums2, n) {
  ...
  for (let i = 0; i < n; i++) {
    nums1[m + i] = nums2[i]; // Insert nums2's elements into nums1 after the m elements
  }
  nums1.sort((a, b) => a - b);
};
